...
public class ParancsFactory {
    ...
    public static Parancs letrehozParancs(int parancsKod) {
        switch (parancsKod) {
            ...
            case 31: return new LehelyezViztisztito(BALLE);
            case 32: return new LehelyezViztisztito(LE);
            case 33: return new LehelyezViztisztito(JOBBLE);
            case 34: return new LehelyezViztisztito(BAL);
            case 36: return new LehelyezViztisztito(JOBB);
            case 37: return new LehelyezViztisztito(BALFEL);
            case 38: return new LehelyezViztisztito(FEL);
            case 39: return new LehelyezViztisztito(JOBBFEL);
            ...
            case 95: return new SutBurgonya();
